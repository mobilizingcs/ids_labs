...
- Make a `dotPlot` of your _predominant color_ again; but this time, facet the plot by introvert/extrovert variable. Include the `layout` argument to stack the plots.
- Use a line of code, using similar syntax to how you facet plots, to _calculate_ a value that describes the _center_ of your predominant color for introverts and extroverts.
    - **Do introverts or extroverts differ in their typical scores for your predominant color? Answer this statistical question using your `dotPlot` and numerical summaries.**
