...
- Before analyzing a new data set, it's often helpful to get familiar with it. So:
    ...
    - **Write down the `names` of the variables that tell us an observation's introverts/extroverts designation and whether they participated in playing _sports_.**
