...
```
- **Compute the proportion of `"rap"` songs for your 50 draws and find out if the _range_ for your class's proportions is bigger or smaller than when we drew 10 songs.**
