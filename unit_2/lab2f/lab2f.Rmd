...
- <span class="blue">After shuffling your data, use the `mutate` function to create a variable called _diff_ which is the `median` fare of survivors minus the `median` fare of non-survivors.</span>
