...
- <span class="blue">Click on the name of the file and choose the option "Import Data set...".</span>
...
- After you <font color="green">Export</font>, <font color="green">Upload</font>, <font color="green">Import</font> your data you're ready to analyze. 
- <span class="blue">`View` your data, select a variable and try to make an appropriate plot for that variable.</span>