...
- Recall that  there were `r tally(~gender, data = atu_clean)[2] - tally(~gender, data = atu_clean)[1]` more women than men in our dataset.
...
- What does this mean?
  ...
  - In the second two-way frequency table the groups being compared are people with `No difficulty` and `Has difficulty` on the distribution of gender.
