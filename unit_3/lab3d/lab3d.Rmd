...
- <span class="blue">Load the built-in `atus` (_American Time Use Survey_) data set, which is a survey of how a sample of Americans spent their day.</span>
...
- <span class="blue">Use the `slice` function to create a new data set that includes each row from our `sample`.</span>
