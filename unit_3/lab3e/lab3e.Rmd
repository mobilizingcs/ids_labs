...
- <span class="blue">Then fill in the blanks below to have `R` scrape _every_ web table available on the site:</span>
...
- <span class="blue">Use the `length()` function to find out how many tables of data were scraped in our set of `tables`.</span>
...
- <span class="blue">Use `readHTMLTable()` to re-scrape the data from the web but this time use the `which` argument to scrape just the individual table.</span>
...
- <span class="blue">Fill in the blanks to save the data and give it a file name.</span>
```{r, eval = FALSE, echo = TRUE}
