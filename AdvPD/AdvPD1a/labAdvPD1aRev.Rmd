...
The `xlim` argument along with the `c()` function allow you to choose a range of values to plot for a single variable distribution.
...
**5. For which other type of plot might it be appropriate to use the 'ylim' argument? Explain.**  
