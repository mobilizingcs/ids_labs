...
* Option:  `col= " "` . Changes the color of your visual [(See Colors)](http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf)

* Option:  `xlab = " "` .  Changes the label on the x-axis  
* Option:  `ylab = " "` . Changes the label on the y-axis  
* Option:  `horizontal = TRUE` . Makes bars horizontal <a href="http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf"  target="_blank">See Colors</a>
