...
- <span class="blue">Before moving on, load the `movie` data and split it into two sets:</span>
    ...
    - <span class="blue">And a set named `testing` that includes the remaining 25%.</span>
...
- <span class="blue">Fill in the blanks below to create a scatterplot with `audience_rating` on the y-axis and `critics_rating` on the x-axis using your `testing` data.</span>
...
- <span class="blue">Fill in the blanks below to</span>
    - <span class="blue">create a scatterplot with `audience_rating` on the y-axis and `critics_rating` on the x-axis using your `testing` data, and</span>
...
- **Use the `test` MSE to verify which model is the best at predicting the `testing` data.**
