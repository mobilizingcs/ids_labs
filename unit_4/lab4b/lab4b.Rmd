...
- To solve this problem we calculate the squared values of the errors.
...
- <span class="blue">Create a _regression line_ or _linear model_ for `height` and `armspan`.</span>
...
- **What do you think the value of the sum of the residuals wil be for the line of best fit? Why?**

- <span class="blue">Calculate the sum of the residuals for the _line of best fit_ .</span>

- **Why do you think it is so close to zero?**