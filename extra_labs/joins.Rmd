...
<li>Previously, <span style="color: blue;">colors</span> and <span style="color: blue;">time_use</span> had the same number of observations. Moreover, the values for <span style="color: blue;">user.id</span> were exactly the same in <span style="color: blue;">colors</span> and <span style="color: blue;">time_use</span>.</li>
