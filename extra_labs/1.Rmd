...
On the previous slide you learned how to manually choose a color for each category of asthma. But what if there were a lot of categories for your variable? This is where a color palette might come in handy.
...
bargraph(~drink_water, data=cdc, groups = drink_water,
         col = palette,
         stack=T)
...
```{r, eval = TRUE, echo = TRUE, fig.height=4, fig.width=5}
xyplot(weight~height,data=cdc, groups=gender, col=c("purple","blue"))
```
