...
title: "Factors"
author:
date: R's basic data structures include the data frame, vector, list, matrix and array.The following slides contain information about factors, which are special types of vectors that store categorical data.
output:
...
On the last slide, the final product was a visualization. The codes below shows how to incorporate a graphic using the pipe. The first utilizes lattice graphics and the second ggplot2.
