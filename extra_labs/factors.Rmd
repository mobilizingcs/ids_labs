...
Use what you learned in this lab to create the following (Hint: refer to slide 7):
...
Unfortunately, the order of the levels are assigned in alpha order.  To change the order of the levels you would use the same code learned in slide #7.