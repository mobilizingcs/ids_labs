...
Select a pre-loaded data set of your choice using the command:

```{r, eval=FALSE}
data()
```

Create the four basic plots using the dollar sign syntax. Include arguments to make your graphic clear.
