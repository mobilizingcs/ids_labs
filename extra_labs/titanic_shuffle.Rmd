...
The code below shows what might have happened in an alternate universe where the Titanic sails again but this time survival is determined via a lottery system.
...
This code creates a new dataframe. Each row represents a simulation of holding a lottery to determine survival.
...
The code below will create a new column in our shuffled_outcomes dataframe which shows how much the mean fare differed between survivors and non-survivors.
