...
plot1<-bwplot(~blue, data = colors, col ="blue")
plot2<-bwplot(~gold, data = colors, col ="gold")
plot3<-bwplot(~green, data = colors, col ="green", xlim=c(4, 21))
plot4<-bwplot(~orange, data = colors, col ="orange")
```
